...
public class TesteTarefa {
    public static void main(String[] args) {
        NossoVetor v;
        int tamanhoDoVetor = 100000; // A Machion pediu 100mil, 200mil, 400mil, 800mil e 1,6milhão.
        int quantidadeDeIteracoes = 1; // A Machion pediu 10 iterações para 1,6milhão e 30 para o resto.
        ...
        for(int i=0; i<quantidadeDeIteracoes; i++){
            ...
            long valorASerBuscado = v.buscaPeloIndice(random.nextInt(tamanhoDoVetor));
            long custoBuscaBinaria = v.buscaBinaria(valorASerBuscado);
            long custoBuscaBinariaTotal = custoBuscaBinaria + comparacoes_insertion;
            listaBuscaBinaria.insere(custoBuscaBinariaTotal);
            System.out.println("Custo busca binária, apenas: " + custoBuscaBinaria);
            System.out.println("Custo busca binária + custo de ordenação: " + custoBuscaBinariaTotal);
